 ...
 *	교환 창 관련
 */
class CPythonExchange : public Singleton<CPythonExchange>
{
	public:
		enum
		{
		...
		typedef struct trade
		{
			...
			uint32_t					item_metin[EXCHANGE_ITEM_MAX_NUM][ITEM::SOCKET_MAX_NUM];
			TPlayerItemAttribute	item_attr[EXCHANGE_ITEM_MAX_NUM][ITEM::ATTRIBUTE_MAX_NUM];
