...
class CPythonPlayer : public Singleton<CPythonPlayer>
{
	public:
		enum
		{
		...
		{		    
			...
			void SetPoint(UINT ePoint, int32_t lPoint);
			int32_t GetPoint(UINT ePoint);
		} TPlayerStatus;
	...
	public:
		...
		void	SetGameWindow(pybind11::handle ppyObject);
	...
	protected:
		pybind11::handle				m_ppyGameWindow;
