...
class CInstanceBase;
class CPythonSkill : public Singleton<CPythonSkill>
{
	public:
		enum
		{
		...
		enum
		{
			SKILL_NEED_WEAPON_SWORD				= (1 << ITEM::WEAPON_SWORD),
			SKILL_NEED_WEAPON_DAGGER			= (1 << ITEM::WEAPON_DAGGER),
			SKILL_NEED_WEAPON_BOW				= (1 << ITEM::WEAPON_BOW),
			SKILL_NEED_WEAPON_TWO_HANDED		= (1 << ITEM::WEAPON_TWO_HANDED),
			SKILL_NEED_WEAPON_DOUBLE_SWORD		= (1 << ITEM::WEAPON_DAGGER),
			SKILL_NEED_WEAPON_BELL				= (1 << ITEM::WEAPON_BELL),
			SKILL_NEED_WEAPON_FAN				= (1 << ITEM::WEAPON_FAN),
			SKILL_NEED_WEAPON_ARROW				= (1 << ITEM::WEAPON_ARROW),
			SKILL_NEED_WEAPON_EMPTY_HAND		= (1 << ITEM::WEAPON_NONE),
		};
