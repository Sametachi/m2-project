...
uint32_t CRaceMotionDataAccessor::MakeEvent(int32_t iEventType)
{
	switch (iEventType)
	{
...
void CRaceMotionDataAccessor::DeleteEvent(uint32_t dwIndex)
{
	...
	for (uint32_t i = 0; i < dwIndex; ++i, ++itor);
...
void CRaceMotionDataAccessor::SetMotionType(int32_t iType)
{
	m_MotionAttackData.iMotionType = iType;
}

void CRaceMotionDataAccessor::SetAttackType(int32_t iType)
{
	m_MotionAttackData.iAttackType = iType;
}

void CRaceMotionDataAccessor::SetHittingType(int32_t iType)
{
...
void CRaceMotionDataAccessor::SetHitLimitCount(int32_t iCount)
{
...
void CRaceMotionDataAccessor::SetLoopCount(int32_t iLoopCount)
{
