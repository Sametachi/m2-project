...
int32_t CObjectData::GetLightType(uint32_t dwIndex)
{
	TLightElementData * pData;
	if (!GetLightDataPointer(dwIndex, &pData))
...
void CObjectData::SetLightType(uint32_t dwIndex, int32_t iType)
{
	TLightElementData * pData;
	if (!GetLightDataPointer(dwIndex, &pData))
		return;
...
bool CObjectData::GetLight(uint32_t dwIndex, const D3DLIGHT8 ** ppd3dLight)
{
...
void CObjectData::SetLightDiffuse(uint32_t dwIndex, int32_t iRed, int32_t iGreen, int32_t iBlue)
{
	TLightElementData * pData;
	if (!GetLightDataPointer(dwIndex, &pData))
		return;
...
void CObjectData::SetLightAmbient(uint32_t dwIndex, int32_t iRed, int32_t iGreen, int32_t iBlue)
{
	TLightElementData * pData;
	if (!GetLightDataPointer(dwIndex, &pData))
		return;
...
void CObjectData::SetLightSpecular(uint32_t dwIndex, int32_t iRed, int32_t iGreen, int32_t iBlue)
{
	TLightElementData * pData;
	if (!GetLightDataPointer(dwIndex, &pData))
		return;
...
void CObjectData::SetMaterialDiffuse(int32_t iRed, int32_t iGreen, int32_t iBlue)
{
...
void CObjectData::SetMaterialAmbient(int32_t iRed, int32_t iGreen, int32_t iBlue)
{
...
void CObjectData::SetMaterialSpecular(int32_t iRed, int32_t iGreen, int32_t iBlue)
{
...
void CObjectData::SetMaterialEmissive(int32_t iRed, int32_t iGreen, int32_t iBlue)
{
...
int32_t CObjectData::GetTexturingOperation(int32_t iStage, int32_t iType)
{
	return m_LightData.TextureState[iStage][iType].iOperation;
}

int32_t CObjectData::GetTexturingArgument(int32_t iStage, int32_t iType, int32_t iIndex)
{
	return m_LightData.TextureState[iStage][iType].iArgument[iIndex];
}

void CObjectData::SetTexturingOperation(int32_t iStage, int32_t iType, int32_t iOperation)
{
	m_LightData.TextureState[iStage][iType].iOperation = iOperation;
}

void CObjectData::SetTexturingArgument(int32_t iStage, int32_t iType, int32_t iIndex, int32_t iArgument)
{
	m_LightData.TextureState[iStage][iType].iArgument[iIndex] = iArgument;
}

bool CObjectData::isEnableTexture(int32_t iIndex)
{
	return m_LightData.TextureData[iIndex].bEnable;
}

void CObjectData::SetEnableTexture(int32_t iIndex, BOOL bFlag)
{
	m_LightData.TextureData[iIndex].bEnable = bFlag == 1 ? TRUE : FALSE;
}

void CObjectData::LoadTexture(int32_t iIndex, const char * c_szFileName)
{
...
bool CObjectData::GetTexture(int32_t iIndex, LPDIRECT3DTEXTURE8 * plpTexture)
{
...
const char * CObjectData::GetTextureName(int32_t iIndex)
{
...
const char * IndexingKey(int32_t iIndex, const char * c_szFileName)
{
