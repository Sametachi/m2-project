...
void CEffectElementBaseAccessor::SaveScript(int32_t iBaseTab, FILE * File)
{
...
void CEffectElementBaseAccessor::SetValuePosition(uint32_t dwIndex, const D3DXVECTOR3 & c_rVector)
{
	if (dwIndex >= m_TimeEventTablePosition.size())
		return;
...
void CEffectElementBaseAccessor::SetValueControlPoint(uint32_t dwIndex, const D3DXVECTOR3 & c_rVector)
{
	if (dwIndex >= m_TimeEventTablePosition.size())
		return;
...
void CLightAccessor::SaveScript(int32_t iBaseTab, FILE* File)
{
...
void CParticleAccessor::SaveScript(int32_t iBaseTab, FILE * File, const char * c_szGlobalPath)
{
	// Emitter Property
...
int32_t & CParticleAccessor::GetLoopCountReference()
{
	return m_EmitterProperty.m_iLoopCount;
}
uint8_t & CParticleAccessor::GetEmitterShapeReference()
{
	return m_EmitterProperty.m_byEmitterShape;
}
uint8_t & CParticleAccessor::GetEmitterAdvancedTypeReference()
{
...
// Particle Property
uint8_t & CParticleAccessor::GetSrcBlendTypeReference()
{
	return m_ParticleProperty.m_bySrcBlendType;
}

uint8_t & CParticleAccessor::GetDestBlendTypeReference()
{
	return m_ParticleProperty.m_byDestBlendType;
}

uint8_t & CParticleAccessor::GetColorOperationTypeReference()
{
	return m_ParticleProperty.m_byColorOperationType;
}

uint8_t & CParticleAccessor::GetBillboardTypeReference()
{
	return m_ParticleProperty.m_byBillboardType;
}

uint8_t & CParticleAccessor::GetTexAniTypeReference()
{
...
uint8_t & CParticleAccessor::GetRotationTypeReference()
{
...
uint16_t & CParticleAccessor::GetRotationRandomStartBeginReference()
{
	return m_ParticleProperty.m_wRotationRandomStartingBegin;
}
uint16_t & CParticleAccessor::GetRotationRandomStartEndReference()
{
...
BOOL CParticleAccessor::GetImagePointer(uint32_t dwIndex, CGraphicImage ** ppImage)
{
...
void CMeshAccessor::SaveScript(int32_t iBaseTab, FILE * File, const char * c_szGlobalPath)
{
	std::string strLocalFileName;
...
void CMeshAccessor::SetMeshAnimationLoopCount(int32_t iNewCount)
{
