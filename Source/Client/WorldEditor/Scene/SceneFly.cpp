...
void CSceneFly::OnKeyDown(int32_t iChar)
{
	if (VK_SPACE == iChar)
	{
		Play();
...
void CSceneFly::OnKeyUp(int32_t iChar)
{
}

void CSceneFly::OnMouseMove(int32_t x, int32_t y)
{
...
BOOL CSceneFly::OnMouseWheel(int16_t zDelta)
{
	return FALSE;
}
