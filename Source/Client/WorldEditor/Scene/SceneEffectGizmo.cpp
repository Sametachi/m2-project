...
void CSceneEffect::OnKeyDown(int32_t iChar)
{
	switch (iChar)
	{
		case VK_SPACE:
...
void CSceneEffect::OnKeyUp(int32_t iChar)
{
}
BOOL CSceneEffect::OnMouseWheel(int16_t zDelta)
{
...
void CSceneEffect::OnMouseMove(int32_t ix, int32_t iy)
{
