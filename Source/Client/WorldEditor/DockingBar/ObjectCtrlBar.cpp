...
const int32_t c_iTemporaryHeight = 27;
...
int32_t CObjectCtrlBar::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CObjectCtrlBar::OnSize(UINT nType, int32_t cx, int32_t cy)
{
