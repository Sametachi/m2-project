...
protected:
	...
	int32_t SliderValueToCursorRotation(int32_t iStep, int32_t iCount, int32_t iAmount);
	int32_t CursorRotationToSliderValue(int32_t iRotation, int32_t iCount, int32_t iAmount);
