...
public:
    ...
    virtual CSize CalcDynamicLayout(int32_t nLength, uint32_t dwMode);
...
protected:
    ...
    UINT GetEdgeHTCode(int32_t nEdge);
    ...
    const int32_t FindSizingBar(CControlBar* pBar) const;
    void GetRowInfo(int32_t& nFirst, int32_t& nLast, int32_t& nThis);
    void GetRowSizingBars(CSCBArray& arrSCBars);
    BOOL NegociateSpace(int32_t nLengthAvail, BOOL bHorz);
