...
const int32_t c_iTemporaryWidth = 0;
const int32_t c_iTemporaryHeight = 25;
...
uint8_t CMapCtrlBar::UpdatePage()
{
	uint8_t ucMode;
...
int32_t CMapCtrlBar::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CMapCtrlBar::OnSize(UINT nType, int32_t cx, int32_t cy)
{
