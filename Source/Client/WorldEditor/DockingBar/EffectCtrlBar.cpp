...
const int32_t c_iTemporaryHeight = 280+50; // @fixme114
...
int32_t CEffectCtrlBar::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CEffectCtrlBar::OnSize(UINT nType, int32_t cx, int32_t cy)
{
