...
void CPageCtrl::CalcLayout()
{
	...
	{
		int32_t gap = (prc.Width() - drc.Width())/2;
		CRect rc = drc;
		rc.left += gap;
		rc.right += gap;
		MoveWindow(&rc);
...
BOOL CPageCtrl::OnMouseWheel(UINT nFlags, int16_t zDelta, CPoint pt)
{
	// TODO: Add your message handler code here and/or call default
	int32_t dy = zDelta/6;
...
void CPageCtrl::SetTemporaryHeight(int32_t nTemporaryHeight)
{
