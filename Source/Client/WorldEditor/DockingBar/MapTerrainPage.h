...
// Dialog Data
	...
	int32_t		m_iBrushSize;
	int32_t		m_iStrengthSize;
	int32_t		m_iWaterheight;
	//}}AFX_DATA
	int32_t GetBrushSize()		{ return m_iBrushSize;		}
	int32_t GetBrushStrength()	{ return m_iStrengthSize;	}
...
//	char szAlphaScaleText[16];
	...
	afx_msg void OnCheckWaterBrushTo0z();
	afx_msg void OnCheckWaterBrushPlus1z();
	afx_msg void OnCheckWaterBrushMinus1z();
	...
	afx_msg void OnCheckWaterTextureEnable();
	afx_msg void OnSetWaterTexture();
#endif
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
