...
protected:
	...
	void SetSkyBoxTexture( int32_t iFaceIndex );

protected:
	int32_t m_iSliderIndex;
...
public:
	...
	// new stuff
	afx_msg void OnCheckRecalculateShadow();
	afx_msg void OnCheckBackGroundPlayMusic();
	afx_msg void OnCheckBackGroundPlaySound();
	afx_msg void OnCheckBackGroundPlayFadeIn();
	afx_msg void OnCheckBackGroundPlayFadeOut();
	afx_msg void OnCheckBackGroundStopMusic3D();
	afx_msg void OnCheckBackGroundStopFadeOut();
