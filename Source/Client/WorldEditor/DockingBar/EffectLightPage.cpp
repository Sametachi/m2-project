...
void CEffectLightPage::UpdateUI()
{
	...
	COLORREF DiffuseColor = RGB(uint16_t(pAccessor->GetDiffuseColorReference().r*255.0f),
							 uint16_t(pAccessor->GetDiffuseColorReference().g*255.0f),
							 uint16_t(pAccessor->GetDiffuseColorReference().b*255.0f));
	COLORREF AmbientColor = RGB(uint16_t(pAccessor->GetAmbientColorReference().r*255.0f),
							 uint16_t(pAccessor->GetAmbientColorReference().g*255.0f),
							 uint16_t(pAccessor->GetAmbientColorReference().b*255.0f));
