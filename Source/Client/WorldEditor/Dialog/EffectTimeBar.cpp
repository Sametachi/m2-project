...
void CEffectTimeBar::SetData(uint32_t dwSelectedIndex)
{
	...
	int32_t iCurSel = m_ctrlGraphList.GetCurSel();

	int32_t iCount = m_ctrlGraphList.GetCount();
...
void CEffectTimeBar::CreateBitmapButton(int32_t iButtonID, int32_t iBitmapID, CBitmap & rBitmap)
{
	CButton * pButton;
...
int32_t CEffectTimeBar::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CEffectTimeBar::OnSize(UINT nType, int32_t cx, int32_t cy)
{
