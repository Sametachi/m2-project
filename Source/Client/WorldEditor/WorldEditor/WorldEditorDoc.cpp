...
void CWorldEditorDoc::SetActiveMode(int32_t iMode)
{
	std::map<int32_t, CSceneBase*>::iterator itor = m_ScenePointerMap.find(iMode);
...
int32_t CWorldEditorDoc::GetActiveMode()
{
