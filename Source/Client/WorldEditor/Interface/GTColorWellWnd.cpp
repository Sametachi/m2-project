...
BOOL GTColorWellWnd::Create(uint32_t dwStyle,CRect rcPos, CWnd* pParent,UINT nID,int32_t nBulletType,BOOL bPopup)
{
	nBulletType;
	bPopup;
...
void GTColorWellWnd::OnSize(UINT nType, int32_t cx, int32_t cy)
{
...
int32_t GTColorWellWnd::OnSelectBulletOK(UINT wParam, int32_t lParam)
{
	wParam;
	lParam;
