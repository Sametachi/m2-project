...
public:
    ...
    virtual HINSTANCE GotoURL(LPCTSTR url, int32_t showcmd);
...
// Implementation
protected:
    virtual void ReportError(int32_t nError);
    virtual int32_t GetRegKey(HKEY key, LPCTSTR subkey, LPTSTR retdata);
