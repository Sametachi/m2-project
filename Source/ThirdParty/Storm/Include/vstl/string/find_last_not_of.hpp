...
#ifndef VSTL_STRING_FINDLASTNOTOF_HPP
#define VSTL_STRING_FINDLASTNOTOF_HPP
...
string_iterator<Iterator, Traits> find_last_not_of(
...
{
	return vstd::find_last_not_of(firstA, lastA, firstB, lastB - firstB);
}
