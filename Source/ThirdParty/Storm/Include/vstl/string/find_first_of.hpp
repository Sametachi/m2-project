...
#ifndef VSTL_STRING_FINDFIRSTOF_HPP
#define VSTL_STRING_FINDFIRSTOF_HPP
...
string_iterator<Iterator, Traits> find_first_of(
...
{
	return vstd::find_first_of(firstA, lastA, firstB, lastB - firstB);
}
