...
public:
	...
	bool SetTexture(uint32_t ulIndex, const char* c_szFileName, float fuScale, float fvScale, float fuOffset, float fvOffset, bool bSplat, uint16_t usBegin, uint16_t usEnd, float fTerrainTexCoordBase);
	void Reload(float fTerrainTexCoordBase);
	bool ReplaceTexture(const char* c_szFileName, const char* c_OldszFileName, float fuScale, float fvScale, float fuOffset, float fvOffset, bool bSplat, uint16_t usBegin, uint16_t usEnd, float fTerrainTexCoordBase);
