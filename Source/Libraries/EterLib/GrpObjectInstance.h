...
public:
	...
	const D3DXVECTOR3& GetAttachmentScale() const;
	...
	void SetAttachmentScale(const D3DXVECTOR3& newscale);

	void Clear();
	void Update();
	bool Render();
	void BlendRender();
	void RenderToShadowMap(bool showWeapon);
	void RenderShadow();
...
protected:
	...
	D3DXVECTOR3	m_v3ScaleAttachment = { 1.0f, 1.0f, 1.0f };
	D3DXMATRIX m_matAttachedWorldTransform;
	D3DXMATRIX m_matScaleTransformation;
