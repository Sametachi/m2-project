...
void CEffectInstance::OnUpdate()
{
...
#ifdef WORLD_EDITOR
	FEffectUpdator f(CTimer::GetInstance()->GetElapsedSecond());
#else
	FEffectUpdator f(CTimer::GetInstance()->GetCurrentSecond()-m_fLastTime);
#endif
	...
	m_fLastTime = CTimer::GetInstance()->GetCurrentSecond();
}
