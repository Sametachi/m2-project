...
extern const TPointInfo		aApplyInfo[ITEM::MAX_APPLY_NUM];
extern const TMobRankStat       MobRankStats[MOB::RANK_MAX_NUM];

extern TBattleTypeStat		BattleTypeStats[MOB::BATTLE_TYPE_MAX_NUM];
...
extern const int32_t		aiMobEnchantApplyIdx[MOB::ENCHANTS_MAX_NUM];
extern const int32_t		aiMobResistsApplyIdx[MOB::RESISTS_MAX_NUM];

extern const int32_t		aSkillAttackAffectProbByRank[MOB::RANK_MAX_NUM];

extern const int32_t aiItemMagicAttributePercentHigh[ITEM::ATTRIBUTE_MAX_LEVEL];
extern const int32_t aiItemMagicAttributePercentLow[ITEM::ATTRIBUTE_MAX_LEVEL];

extern const int32_t aiItemAttributeAddPercent[ITEM::ATTRIBUTE_MAX_NUM];

extern const int32_t aiWeaponSocketQty[ITEM::WEAPON_NUM_TYPES];
extern const int32_t aiArmorSocketQty[ITEM::ARMOR_NUM_TYPES];
