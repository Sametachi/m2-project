...
class CDungeon
{
	typedef TR1_NS::unordered_map<LPPARTY, int32_t> TPartyMap;
	...
	void	IncMonster() { m_iMonsterCount++; PyLog("MonsterCount {}", m_iMonsterCount); }
	...
	void	IncKillCount(LPCHARACTER pKiller, LPCHARACTER pVictim);
	...
	CHARACTER_SET	    m_set_pCharacter;
...
class CDungeonManager : public Singleton<CDungeonManager>
{
	...
	private:
	TDungeonMap	m_map_pDungeon;
	TMapDungeon m_map_pMapDungeon;
