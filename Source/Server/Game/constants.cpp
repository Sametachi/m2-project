 ...
 */
{
	// str con dex int32_t Initial HP Initial SP CON/HP int32_t/SP HP Random/lv MP Random/lv Initial stam stam/con stam/lv
...
const TMobRankStat MobRankStats[MOB::RANK_MAX_NUM] =
/*
   {
...
TBattleTypeStat BattleTypeStats[MOB::BATTLE_TYPE_MAX_NUM] =
/*
   {
...
const int32_t aiMobEnchantApplyIdx[MOB::ENCHANTS_MAX_NUM] =
{
	ITEM::APPLY_CURSE_PCT,
	ITEM::APPLY_SLOW_PCT,
...
const int32_t aiMobResistsApplyIdx[MOB::RESISTS_MAX_NUM] =
{
...
const int32_t aiWeaponSocketQty[ITEM::WEAPON_NUM_TYPES] =
{
	3, // WEAPON_SWORD,
	3, // WEAPON_DAGGER,
	3, // WEAPON_BOW,
...
const int32_t aiArmorSocketQty[ITEM::ARMOR_NUM_TYPES] =
{
	3, // ARMOR_BODY,
	1, // ARMOR_HEAD,
	1, // ARMOR_SHIELD,
...
const TPointInfo aApplyInfo[ITEM::MAX_APPLY_NUM] =
/*
{
 ...
 */
{
	...
	{ POINT_RESIST_WARRIOR,		},		// 78
	{ POINT_RESIST_ASSASSIN,	},		// 79
	{ POINT_RESIST_SURA,		},		// 80
	{ POINT_RESIST_SHAMAN,		},		// 81
	{ POINT_DEF_GRADE			},		// 83
	{ POINT_COSTUME_ATTR_BONUS	},		// 84
	{ POINT_MAGIC_ATT_BONUS_PER },		// 85
	{ POINT_MELEE_MAGIC_ATT_BONUS_PER},	// 86 
	{ POINT_RESIST_ICE,			},   // 87
	{ POINT_RESIST_EARTH,		},   // 88
	{ POINT_RESIST_DARK,		},   // 89
	{ POINT_RESIST_CRITICAL,		},   // 90
	{ POINT_RESIST_PENETRATE,		},   // 91
};

const int32_t aiItemMagicAttributePercentHigh[ITEM::ATTRIBUTE_MAX_LEVEL] =
{
	//25, 25, 40, 8, 2,
	30, 40, 20, 8, 2
};

const int32_t aiItemMagicAttributePercentLow[ITEM::ATTRIBUTE_MAX_LEVEL] =
{
	//45, 25, 20, 10, 0,
	50, 40, 10, 0, 0
};
...
// ADD_ITEM_ATTRIBUTE
const int32_t aiItemAttributeAddPercent[ITEM::ATTRIBUTE_MAX_NUM] =
{
	100, 80, 60, 50, 30, 0, 0, 
};
...
// Figures for accessory sockets

// Probability when adding sockets with diamonds
const int32_t aiAccessorySocketAddPct[ITEM_ACCESSORY_SOCKET_MAX_NUM] =
{
	50, 50, 50
};

// How many percent of the accessory's numerical value is added
...
TValueName c_aApplyTypeNames[] =
{
    ...
    { "CON",		ITEM::APPLY_CON		},
    { "INT",		ITEM::APPLY_INT		},
    { "MAX_HP",		ITEM::APPLY_MAX_HP		},
    { "MAX_SP",		ITEM::APPLY_MAX_SP		},
    { "MAX_STAMINA",	ITEM::APPLY_MAX_STAMINA	},
    { "POISON_REDUCE",	ITEM::APPLY_POISON_REDUCE	},
    { "EXP_DOUBLE_BONUS", ITEM::APPLY_EXP_DOUBLE_BONUS },
    { "GOLD_DOUBLE_BONUS", ITEM::APPLY_GOLD_DOUBLE_BONUS },
    { "ITEM_DROP_BONUS", ITEM::APPLY_ITEM_DROP_BONUS	},
    { "HP_REGEN",	ITEM::APPLY_HP_REGEN		},
    { "SP_REGEN",	ITEM::APPLY_SP_REGEN		},
    { "ATTACK_SPEED",	ITEM::APPLY_ATT_SPEED		},
    { "MOVE_SPEED",ITEM::APPLY_MOV_SPEED		},
    { "CAST_SPEED",	ITEM::APPLY_CAST_SPEED	},
    { "ATT_BONUS",	ITEM::APPLY_ATT_GRADE_BONUS	},
    { "DEF_BONUS",	ITEM::APPLY_DEF_GRADE_BONUS	},
    { "MAGIC_ATT_GRADE",ITEM::APPLY_MAGIC_ATT_GRADE	},
    { "MAGIC_DEF_GRADE",ITEM::APPLY_MAGIC_DEF_GRADE	},
    { "SKILL",		ITEM::APPLY_SKILL		},
    { "ATTBONUS_ANIMAL",ITEM::APPLY_ATTBONUS_ANIMAL	},
    { "ATTBONUS_UNDEAD",ITEM::APPLY_ATTBONUS_UNDEAD	},
    { "ATTBONUS_DEVIL", ITEM::APPLY_ATTBONUS_DEVIL	},
    { "ATTBONUS_HUMAN", ITEM::APPLY_ATTBONUS_HUMAN	},
    { "ADD_BOW_DISTANCE",ITEM::APPLY_BOW_DISTANCE	},
    { "DODGE",		ITEM::APPLY_DODGE		},
    { "BLOCK",		ITEM::APPLY_BLOCK		},
    { "RESIST_SWORD",	ITEM::APPLY_RESIST_SWORD	},
    { "RESIST_TWOHAND",	ITEM::APPLY_RESIST_TWOHAND	},
    { "RESIST_DAGGER",	ITEM::APPLY_RESIST_DAGGER    },
    { "RESIST_BELL",	ITEM::APPLY_RESIST_BELL	},
    { "RESIST_FAN",	ITEM::APPLY_RESIST_FAN	},
    { "RESIST_BOW",	ITEM::APPLY_RESIST_BOW	},
    { "RESIST_FIRE",	ITEM::APPLY_RESIST_FIRE	},
    { "RESIST_ELEC",	ITEM::APPLY_RESIST_ELEC	},
    { "RESIST_MAGIC",	ITEM::APPLY_RESIST_MAGIC	},
    { "RESIST_WIND",	ITEM::APPLY_RESIST_WIND	},
	{ "REFLECT_MELEE",	ITEM::APPLY_REFLECT_MELEE },
	{ "REFLECT_CURSE",	ITEM::APPLY_REFLECT_CURSE },
    { "RESIST_ICE",		ITEM::APPLY_RESIST_ICE	},
    { "RESIST_EARTH",	ITEM::APPLY_RESIST_EARTH	},
    { "RESIST_DARK",	ITEM::APPLY_RESIST_DARK	},
    { "RESIST_CRITICAL",	ITEM::APPLY_ANTI_CRITICAL_PCT	},
    { "RESIST_PENETRATE",	ITEM::APPLY_ANTI_PENETRATE_PCT	},
    { "POISON",		ITEM::APPLY_POISON_PCT	},
    { "SLOW",		ITEM::APPLY_SLOW_PCT		},
    { "STUN",		ITEM::APPLY_STUN_PCT		},
    { "STEAL_HP",	ITEM::APPLY_STEAL_HP		},
    { "STEAL_SP",	ITEM::APPLY_STEAL_SP		},
    { "MANA_BURN_PCT",	ITEM::APPLY_MANA_BURN_PCT	},
    { "CRITICAL",	ITEM::APPLY_CRITICAL_PCT	},
    { "PENETRATE",	ITEM::APPLY_PENETRATE_PCT	},
    { "KILL_SP_RECOVER",ITEM::APPLY_KILL_SP_RECOVER	},
    { "KILL_HP_RECOVER",ITEM::APPLY_KILL_HP_RECOVER	},
    { "PENETRATE_PCT",	ITEM::APPLY_PENETRATE_PCT	},
    { "CRITICAL_PCT",	ITEM::APPLY_CRITICAL_PCT	},
    { "POISON_PCT",	ITEM::APPLY_POISON_PCT	},
    { "STUN_PCT",	ITEM::APPLY_STUN_PCT		},
    { "ATT_BONUS_TO_WARRIOR",	ITEM::APPLY_ATT_BONUS_TO_WARRIOR  },
    { "ATT_BONUS_TO_ASSASSIN",	ITEM::APPLY_ATT_BONUS_TO_ASSASSIN },
    { "ATT_BONUS_TO_SURA",	ITEM::APPLY_ATT_BONUS_TO_SURA	    },
    { "ATT_BONUS_TO_SHAMAN",	ITEM::APPLY_ATT_BONUS_TO_SHAMAN   },
    { "ATT_BONUS_TO_MONSTER",	ITEM::APPLY_ATT_BONUS_TO_MONSTER  },
    { "ATT_BONUS_TO_MOB",	ITEM::APPLY_ATT_BONUS_TO_MONSTER  },
    { "MALL_ATTBONUS",	ITEM::APPLY_MALL_ATTBONUS	},
    { "MALL_EXPBONUS",	ITEM::APPLY_MALL_EXPBONUS	},
    { "MALL_DEFBONUS",	ITEM::APPLY_MALL_DEFBONUS	},
    { "MALL_ITEMBONUS",	ITEM::APPLY_MALL_ITEMBONUS	},
    { "MALL_GOLDBONUS", ITEM::APPLY_MALL_GOLDBONUS	},
    { "MAX_HP_PCT",	ITEM::APPLY_MAX_HP_PCT	},
    { "MAX_SP_PCT",	ITEM::APPLY_MAX_SP_PCT	},
    { "SKILL_DAMAGE_BONUS",	ITEM::APPLY_SKILL_DAMAGE_BONUS	},
    { "NORMAL_HIT_DAMAGE_BONUS",ITEM::APPLY_NORMAL_HIT_DAMAGE_BONUS	},
    { "SKILL_DEFEND_BONUS",	ITEM::APPLY_SKILL_DEFEND_BONUS	},
    { "NORMAL_HIT_DEFEND_BONUS",ITEM::APPLY_NORMAL_HIT_DEFEND_BONUS	},
    { "RESIST_WARRIOR",	ITEM::APPLY_RESIST_WARRIOR},
    { "RESIST_ASSASSIN",	ITEM::APPLY_RESIST_ASSASSIN},
    { "RESIST_SURA",		ITEM::APPLY_RESIST_SURA},
    { "RESIST_SHAMAN",	ITEM::APPLY_RESIST_SHAMAN},
    // by mhh game/affect.h Defined. INFINITE_AFFECT_DURATION = 0x1FFFFFFF
    { "INFINITE_AFFECT_DURATION", 0x1FFFFFFF	},
	{ "COSTUME_ATTR_BONUS", ITEM::APPLY_COSTUME_ATTR_BONUS },		//	Energy
	{ "MAGIC_ATTBONUS_PER",	ITEM::APPLY_MAGIC_ATTBONUS_PER	},
    { "MELEE_MAGIC_ATTBONUS_PER",	ITEM::APPLY_MELEE_MAGIC_ATTBONUS_PER	},
