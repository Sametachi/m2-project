...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_LOGIN5_OPENID, sizeof(TPacketCGLogin5), "Login5");
	...
	Set(HEADER_CG_CHARACTER_SELECT, sizeof(TPacketCGCharacterSelect), "Select");
	Set(HEADER_CG_CHARACTER_CREATE, sizeof(TPacketCGCharacterCreate), "Create");
	Set(HEADER_CG_CHARACTER_DELETE, sizeof(TPacketCGCharacterDelete), "Delete");
...
CPacketInfoGG::CPacketInfoGG()
{
	...
	Set(HEADER_GG_RELOAD_CRC_LIST, sizeof(uint8_t), "ReloadCRCList");
