...
//    kSKIPJACK,
  ...
  virtual SymmetricCipher* CreateEncoder(const uint8_t* key, size_t keylen,
                                         const uint8_t* iv) const = 0;
  virtual SymmetricCipher* CreateDecoder(const uint8_t* key, size_t keylen,
                                         const uint8_t* iv) const = 0;
};
