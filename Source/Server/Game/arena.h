...
class CArena
{
	...
	LPCHARACTER GetPlayerA() { return CHARACTER_MANAGER::GetInstance()->FindByPID(m_dwPIDA); }
	LPCHARACTER GetPlayerB() { return CHARACTER_MANAGER::GetInstance()->FindByPID(m_dwPIDB); }
